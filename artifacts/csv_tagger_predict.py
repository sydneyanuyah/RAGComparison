...
def main():
    ...
    p.add_argument("--json_path", default="/data0/projects/Causal_and_Agentic_AI/knowledgegraph2025/sentencetagger/bertlarge/bertlarge_output/top_models_bertlarge.json",
